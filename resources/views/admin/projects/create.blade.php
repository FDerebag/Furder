...
@section('page-title', 'Yeni Proje Ekle')
@section('page-description', 'Portföye yeni proje ekleyin')
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           placeholder="Örn: Adagarden Flowers">
                    @error('title')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="category" 
                            ...
                            <option value="web" {{ old('category') == 'web' ? 'selected' : '' }}>Web Uygulaması</option>
                            <option value="mobile" {{ old('category') == 'mobile' ? 'selected' : '' }}>Mobil Uygulama</option>
                            <option value="desktop" {{ old('category') == 'desktop' ? 'selected' : '' }}>Desktop Uygulama</option>
                            <option value="ecommerce" {{ old('category') == 'ecommerce' ? 'selected' : '' }}>E-Ticaret</option>
                            <option value="crm" {{ old('category') == 'crm' ? 'selected' : '' }}>CRM Sistemi</option>
                            <option value="erp" {{ old('category') == 'erp' ? 'selected' : '' }}>ERP Sistemi</option>
                            <option value="api" {{ old('category') == 'api' ? 'selected' : '' }}>API Geliştirme</option>
                        </select>
                        @error('category')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
                ...
                <div>
                    ...
                    <textarea id="description" 
                              ...
                              required
                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Projenin kısa açıklaması (ana sayfada görünecek)">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea id="detailed_description" 
                              ...
                              rows="5"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
                              placeholder="Projenin detaylı açıklaması">{{ old('detailed_description') }}</textarea>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="file" 
                           ...
                           accept="image/*"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500">
                    <p class="text-sm text-gray-500 mt-1">Birden fazla görsel seçebilirsiniz.</p>
                    @error('gallery.*')
                        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select id="status" 
                            ...
                            <option value="ongoing" {{ old('status') == 'ongoing' ? 'selected' : '' }}>Devam Ediyor</option>
                            <option value="paused" {{ old('status') == 'paused' ? 'selected' : '' }}>Durduruldu</option>
                        </select>
                        @error('status')
                            <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        @enderror
